...
extern EIF_TYPED_VALUE F1313_12000(EIF_REFERENCE);
extern void F1313_12001(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1313_12000 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1313_12001 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1312, Current, 0, 0, 18685);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1312, Current, 18685);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8398, 0xF80005C6, 0); /* implementation */
