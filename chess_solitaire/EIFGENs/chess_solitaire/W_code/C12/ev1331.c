...
extern void F1331_12152(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1331_12153(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1331_12154(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1331_12155(EIF_REFERENCE);
extern void F1331_12156(EIF_REFERENCE);
extern void F1331_12157(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1331_12158(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1331_12159(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1331_12160(EIF_REFERENCE);
...
void F1331_12152 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1330, Current, 0, 1, 18838);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1330, Current, 18838);
	{
...
EIF_TYPED_VALUE F1331_12153 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1330, Current, 0, 0, 18839);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1330, Current, 18839);
	RTIV(Current, RTAL);
...
body:;
	...
	RTNHOOK(2,1);
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(10595, "selected_item", tr1))(tr1)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
...
EIF_TYPED_VALUE F1331_12154 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1330, Current, 1, 0, 18840);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1330, Current, 18840);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_destroyed", EX_PRE);
...
EIF_TYPED_VALUE F1331_12155 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1330, Current, 1, 0, 18841);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1330, Current, 18841);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_destroyed", EX_PRE);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1330, Current, 0, 0, 18842);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1330, Current, 18842);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_destroyed", EX_PRE);
...
body:;
	...
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8398, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(2,1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(10598, "clear_selection", tr1))(tr1);
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
void F1331_12157 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1330, Current, 1, 1, 18843);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1330, Current, 18843);
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,352,0xFF01,229,221,0xFFFF};
		EIF_TYPE typres0;
		static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
...
EIF_TYPED_VALUE F1331_12158 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1330, Current, 0, 0, 18844);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1330, Current, 18844);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (tb2) {
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8403, 1577))(Current)).it_b);
		tb1 = tb2;
	}
...
EIF_TYPED_VALUE F1331_12159 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1330, Current, 0, 1, 18845);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1330, Current, 18845);
	RTCC(arg1, 1330, l_feature_name, 1, eif_new_type(1310, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
EIF_TYPED_VALUE F1331_12160 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
