...
extern EIF_TYPED_VALUE F1596_8836(EIF_REFERENCE);
extern void F1596_8837(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1596_8838(EIF_REFERENCE);
...
/* {KL_LINKABLE}.right */
EIF_TYPED_VALUE F1596_8836 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1596_8837 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1595, Current, 0, 1, 15157);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1595, Current, 15157);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 6616, 0xF800063B, 0); /* right */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
void F1596_8838 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1595, Current, 0, 0, 15158);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1595, Current, 15158);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 6616, 0xF800063B, 0); /* right */
