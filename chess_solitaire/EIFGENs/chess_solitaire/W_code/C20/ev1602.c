...
extern void F1602_13007(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1602_13008(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1602_13009(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1602_13012(EIF_REFERENCE);
static EIF_TYPED_VALUE F1602_13013_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1602_13013(EIF_REFERENCE);
...
void F1602_13007 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1601, Current, 0, 0, 19541);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1601, Current, 19541);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 9952, 0xF800014F, 0); /* child_array */
	tr1 = RTLNSMART(RTWCT(9952, dtype, Dftype(Current)).id);
...
EIF_TYPED_VALUE F1602_13008 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1601, Current, 0, 1, 19542);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1601, Current, 19542);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1602_13009 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1601, Current, 0, 0, 19543);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1601, Current, 19543);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1602_13012 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
static EIF_TYPED_VALUE F1602_13013_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1601, Current, 0, 0, 19545);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1601, Current, 19545);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1602_13013 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9327, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1602_13013_body (Current)).it_r;
