...
extern void F1393_13231(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1393_13233(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1393_13234(EIF_REFERENCE);
static EIF_TYPED_VALUE F1393_13235_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1393_13235(EIF_REFERENCE);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1392, Current, 1, 0, 19701);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F1393_13231 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1392, Current, 2, 1, 19702);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1392, Current, 19702);
	RTCC(arg1, 1392, l_feature_name, 1, eif_new_type(1245, 0x01), 0x01);
	RTIV(Current, RTAL);
...
body:;
	...
	if (!RTCEQ(tr1, arg1)) {
		...
		RTHOOK(4);
		RTDBGAA(Current, dtype, 10113, 0xF80004DD, 0); /* private_font */
		tr1 = RTCCL(loc2);
		RTAR(Current, tr1);
		*(EIF_REFERENCE *)(Current + RTWA(10113, dtype)) = (EIF_REFERENCE) tr1;
		RTHOOK(5);
		...
		RTHOOK(7);
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9525, "font_is_default", loc1))(loc1)).it_b);
		if (tb1) {
			RTHOOK(8);
			...
			tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10112, dtype))(Current)).it_p);
			up1 = tp1;
			tp2 = *(EIF_POINTER *)(loc1 + RTVA(9540, "font_description", loc1));
			up2 = tp2;
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(6175, 970))(Current, up1x, up2x);
		}
	}
...
EIF_TYPED_VALUE F1393_13233 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1392, Current, 0, 0, 19703);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1393_13234 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
static EIF_TYPED_VALUE F1393_13235_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1393_13235 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9327, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1393_13235_body (Current)).it_r;
