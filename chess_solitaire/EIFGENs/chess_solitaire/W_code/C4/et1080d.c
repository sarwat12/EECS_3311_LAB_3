...
static const EIF_TYPE_INDEX egt_13_1080 [] = {0xFF01,334,0xFF01,232,0xFFFF};
...
static const struct desc_info desc_1080[] = {
	...
	{EIF_GENERIC(egt_13_1080), 15632, 0},
	{EIF_GENERIC(egt_14_1080), 15633, 0xFFFFFFFF},
	{EIF_GENERIC(egt_15_1080), 15634, 0xFFFFFFFF},
};
void Init1080(void)
{
	IDSC(desc_1080, 0, 1079);
	IDSC(desc_1080 + 1, 1, 1079);
	IDSC(desc_1080 + 32, 444, 1079);
	IDSC(desc_1080 + 34, 429, 1079);
}
