...
extern EIF_TYPED_VALUE F1370_13035(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1370_13036(EIF_REFERENCE);
static EIF_TYPED_VALUE F1370_13042_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1370_13042(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1370_13035 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1369, Current, 1, 0, 19565);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1369, Current, 19565);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1370_13036 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1369, Current, 1, 0, 19566);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1369, Current, 19566);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(1, 0xF80004DE, 0, 0); /* loc1 */
...
static EIF_TYPED_VALUE F1370_13042_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1369, Current, 0, 0, 19567);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1369, Current, 19567);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1370_13042 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9327, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1370_13042_body (Current)).it_r;
