...
extern void F1386_13199(EIF_REFERENCE);
static EIF_TYPED_VALUE F1386_13201_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1386_13201(EIF_REFERENCE);
...
void F1386_13199 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1385, Current, 0, 0, 19680);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1385, Current, 19680);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		tb1 = '\01';
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10090, dtype))(Current)).it_b);
		if ((EIF_BOOLEAN) !tb2) {
			tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10089, dtype))(Current)).it_b);
			tb1 = tb2;
		}
		RTTE(tb1, label_1);
		RTCK;
...
static EIF_TYPED_VALUE F1386_13201_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1385, Current, 0, 0, 19681);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1385, Current, 19681);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1386_13201 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9327, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1386_13201_body (Current)).it_r;
