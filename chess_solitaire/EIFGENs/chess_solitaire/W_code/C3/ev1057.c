...
#define ur1 ur1x.it_r
	...
	if (EIF_TEST(loc1)) {
		...
		RTDBGAL(0, 0xF800061A, 0,0); /* Result */
		{
			static EIF_TYPE_INDEX typarr0[] = {0xFF01,1562,0xFF01,0xFFF9,1,186,0xFF01,362,0xFF01,238,0xFFFF};
			EIF_TYPE typres0;
		...
		RTHOOK(5);
		RTDBGAA(Current, dtype, 6949, 0xF800061A, 0); /* file_drop_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
#define up1 up1x.it_p
	...
	if (EIF_TEST(loc1)) {
		...
		Result = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6952, 0xF800047F, 0); /* pointer_motion_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
#define up1 up1x.it_p
	...
	if (EIF_TEST(loc1)) {
		...
		Result = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6966, 0xF800047A, 0); /* key_press_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
#define up1 up1x.it_p
	...
	if (EIF_TEST(loc1)) {
		...
		Result = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6968, 0xF8000479, 0); /* key_press_string_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
#define up1 up1x.it_p
	...
	if (EIF_TEST(loc1)) {
		...
		Result = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6970, 0xF800047A, 0); /* key_release_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
#define ur1 ur1x.it_r
	...
	if (EIF_TEST(loc1)) {
		...
		RTHOOK(5);
		RTDBGAA(Current, dtype, 6979, 0xF800047B, 0); /* dpi_changed_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
