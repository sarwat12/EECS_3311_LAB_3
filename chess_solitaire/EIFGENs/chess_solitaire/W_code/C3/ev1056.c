...
static EIF_TYPED_VALUE F1056_9167_body(EIF_REFERENCE);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1055, Current, 1, 0, 15445);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (EIF_TEST(loc1)) {
		...
		RTHOOK(4);
		ur1 = RTCCL(Result);
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(6934, dtype))(Current, ur1x);
		RTHOOK(5);
		RTDBGAA(Current, dtype, 6933, 0xF800047D, 0); /* expose_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
static EIF_TYPED_VALUE F1056_9167_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1056_9167 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6933, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1056_9167_body (Current)).it_r;
...
#define arg1 arg1x.it_r
	...
	RTCC(arg1, 1055, l_feature_name, 1, RTWCT(6932, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
