...
extern void F1137_10123(EIF_REFERENCE);
extern void F1137_10124(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1137_10125(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1137_10126(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1137_10123 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1136, Current, 0, 0, 16674);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1136, Current, 16674);
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(32, 1622))(Current);
	RTHOOK(2);
	...
	*((EIF_INTEGER_32 *)tr4+0) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
	...
	
	{
		...
		typres0 = eif_compound_id(dftype, typarr0);
		tr5= RTLNRW(typres0.id, 0, (EIF_POINTER) _A1137_152_2, (EIF_POINTER)(0),7740, tr3, 0, 1, -1, tr2, 1);
	}
	ur1 = RTCCL(tr5);
	...
	*((EIF_INTEGER_32 *)tr4+0) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
	...
	
	{
		...
		typres0 = eif_compound_id(dftype, typarr0);
		tr5= RTLNRW(typres0.id, 0, (EIF_POINTER) _A1137_153_2, (EIF_POINTER)(0),7741, tr3, 0, 1, -1, tr2, 1);
	}
	ur1 = RTCCL(tr5);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2339, "extend", tr1))(tr1, ur1x);
	RTVI(Current, RTAL);
...
void F1137_10124 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1136, Current, 1, 1, 16675);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1136, Current, 16675);
	...
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		if ((EIF_BOOLEAN)(arg1 != NULL)) {
			...
			if ((EIF_BOOLEAN)(ti4_1 == ((EIF_INTEGER_32) 1L))) {
				ur1 = RTCCL(arg1);
				tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(7742, dtype))(Current, ur1x)).it_b);
				tb2 = (EIF_BOOLEAN) !tb3;
			}
			tb1 = tb2;
		}
...
body:;
	...
	if ((EIF_BOOLEAN)(arg1 != NULL)) {
		...
		RTHOOK(5);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(9604, "enable_parented", loc1))(loc1);
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(6);
...
void F1137_10125 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1136, Current, 1, 1, 16676);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1136, Current, 16676);
	RTCC(arg1, 1136, l_feature_name, 1, RTWCT(2375, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	if ((EIF_BOOLEAN)(arg1 != NULL)) {
		...
		RTHOOK(4);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(9605, "disable_parented", loc1))(loc1);
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(5);
...
EIF_TYPED_VALUE F1137_10126 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1136, Current, 1, 1, 16677);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
