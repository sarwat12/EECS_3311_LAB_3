...
extern void F1138_10128(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1138_10129(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1138_10130(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1138_10131(EIF_REFERENCE);
extern void F1138_10132(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
void F1138_10128 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1137, Current, 1, 1, 16679);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1137, Current, 16679);
	if (arg1) {
		{
	...
	if ((EIF_BOOLEAN)(arg1 != NULL)) {
		...
		switch (ti4_1) {
			case 1L:
				...
				ur1 = RTCCL(tr3);
				tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(7747, dtype))(Current, ur1x)).it_b);
				if (tb1) {
					RTHOOK(4);
...
void F1138_10129 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1137, Current, 0, 1, 16680);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1137, Current, 16680);
	if (arg1) {
		{
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7745, 0xF8000114, 0); /* veto_pebble_function */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
EIF_TYPED_VALUE F1138_10130 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1137, Current, 2, 1, 16681);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1137, Current, 16681);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1138_10131 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1138_10132 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define arg2 arg2x.it_r
	...
	RTEAA(l_feature_name, 1137, Current, 0, 2, 16683);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
