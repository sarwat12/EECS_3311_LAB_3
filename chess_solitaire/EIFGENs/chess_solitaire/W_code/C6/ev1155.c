...
extern void F1155_10183(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1155_10184(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1155_10185(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1155_10183 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1154, Current, 0, 1, 16733);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1154, Current, 16733);
	{
...
void F1155_10184 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1154, Current, 0, 1, 16734);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr2= RTLNRW(typres0.id, 0, (EIF_POINTER) _A1155_183, (EIF_POINTER)(0),7765, 0, 0, 1, -1, tr1, 0);
	}
	ur1 = RTCCL(tr2);
...
EIF_TYPED_VALUE F1155_10185 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1154, Current, 0, 1, 16735);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1154, Current, 16735);
	RTIV(Current, RTAL);
