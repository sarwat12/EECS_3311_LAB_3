...
extern void F1161_10212(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
extern EIF_TYPED_VALUE F1161_10225(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1161_10226(EIF_REFERENCE);
...
void F1161_10212 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1160, Current, 0, 3, 16780);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	ui8_1 = ti8_1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(7785, dtype))(Current, ui8_1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTDBGLE;
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1160, Current, 2, 1, 16785);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	uu8_1 = tu8_1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(7789, dtype))(Current, uu8_1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTDBGLE;
...
#define uu8_1 uu8_1x.it_n8
	...
	RTEAA(l_feature_name, 1160, Current, 0, 1, 16788);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	RTHOOK(4);
	loc1 = RTCCL(arg1);
	loc1 = RTRV(eif_new_type(1193, 0x01),loc1);
	if (EIF_TEST(loc1)) {
		RTHOOK(5);
		...
		RTHOOK(10);
		ur1 = RTCCL(arg1);
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(6357, 1597))(Current, ur1x);
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(11);
...
EIF_TYPED_VALUE F1161_10225 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F1161_10225,16793,RTMS_EX_H("True",4,1416787301));
}
...
EIF_TYPED_VALUE F1161_10226 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F1161_10226,16794,RTMS_EX_H("False",5,1635034981));
}

void EIF_Minit1161 (void)
{
	GTCX
	RTOTS (10225,F1161_10225)
	RTOTS (10226,F1161_10226)
}
