...
extern EIF_TYPED_VALUE F1187_10433(EIF_REFERENCE);
...
RTOID (F1187_10433)
EIF_TYPED_VALUE F1187_10433 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1186, Current, 0, 0, 17045);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1186, Current, 17045);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
