...
EIF_TYPED_VALUE F1003_8613 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1002, Current, 1, 0, 14953);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1002, Current, 14953);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(10981, "horizontal_resolution", loc1))(loc1)).it_i4);
	RTNHOOK(2,1);
