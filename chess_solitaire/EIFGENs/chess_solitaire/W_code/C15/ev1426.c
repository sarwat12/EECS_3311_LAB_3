...
extern void F1426_13644(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1426_13645(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1426_13646_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1426_13646(EIF_REFERENCE);
...
/* {EV_CELL_I}.extend */
void F1426_13644 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1425, Current, 0, 1, 20028);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1425, Current, 20028);
	RTCC(arg1, 1425, l_feature_name, 1, RTWCT(10287, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
void F1426_13645 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1425, Current, 1, 1, 20029);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (EIF_TEST(loc1)) {
		...
		RTNHOOK(2,1);
		ub1 = arg1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(10269, "update_for_pick_and_drop", tr1))(tr1, ub1x);
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
...
/* {EV_CELL_I}.interface */
static EIF_TYPED_VALUE F1426_13646_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1426_13646 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9327, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1426_13646_body (Current)).it_r;
