...
extern void F1443_13929(EIF_REFERENCE);
static EIF_TYPED_VALUE F1443_13933_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1443_13933(EIF_REFERENCE);
...
/* {EV_TREE_I}.make */
void F1443_13929 (EIF_REFERENCE Current)
{
	GTCX
...
/* {EV_TREE_I}.interface */
static EIF_TYPED_VALUE F1443_13933_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1443_13933 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9327, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1443_13933_body (Current)).it_r;
