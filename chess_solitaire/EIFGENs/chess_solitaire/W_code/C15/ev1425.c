...
extern void F1425_13641(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1425_13642(EIF_REFERENCE);
static EIF_TYPED_VALUE F1425_13643_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1425_13643(EIF_REFERENCE);
...
void F1425_13641 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1424, Current, 0, 1, 20025);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1424, Current, 20025);
	RTCC(arg1, 1424, l_feature_name, 1, RTWCT(9327, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1425_13642 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1424, Current, 0, 0, 20026);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1424, Current, 20026);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTHOOK(2);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9322, 1422))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
static EIF_TYPED_VALUE F1425_13643_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1424, Current, 0, 0, 20027);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1424, Current, 20027);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1425_13643 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9327, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1425_13643_body (Current)).it_r;
