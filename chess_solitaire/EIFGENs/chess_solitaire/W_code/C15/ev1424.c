...
extern void F1424_13638(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1424_13639(EIF_REFERENCE);
static EIF_TYPED_VALUE F1424_13640_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1424_13640(EIF_REFERENCE);
...
void F1424_13638 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1423, Current, 0, 1, 20023);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1423, Current, 20023);
	RTCC(arg1, 1423, l_feature_name, 1, RTWCT(9327, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1424_13639 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1423, Current, 0, 0, 20024);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1423, Current, 20024);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
static EIF_TYPED_VALUE F1424_13640_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1423, Current, 0, 0, 20022);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1423, Current, 20022);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1424_13640 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9327, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1424_13640_body (Current)).it_r;
