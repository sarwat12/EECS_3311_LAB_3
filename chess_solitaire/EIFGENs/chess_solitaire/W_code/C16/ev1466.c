...
extern void F1466_14298(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1466_14299(EIF_REFERENCE);
static EIF_TYPED_VALUE F1466_14300_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1466_14300(EIF_REFERENCE);
...
void F1466_14298 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1465, Current, 0, 1, 20507);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1465, Current, 20507);
	RTCC(arg1, 1465, l_feature_name, 1, RTWCT(9327, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1466_14299 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1465, Current, 1, 0, 20508);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1465, Current, 20508);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTHOOK(6);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9322, 1464))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(7);
...
static EIF_TYPED_VALUE F1466_14300_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1465, Current, 0, 0, 20509);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1465, Current, 20509);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1466_14300 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9327, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1466_14300_body (Current)).it_r;
