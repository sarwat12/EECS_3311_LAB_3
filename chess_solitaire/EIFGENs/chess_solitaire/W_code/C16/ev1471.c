...
extern void F1471_14384(EIF_REFERENCE);
extern void F1471_14386(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1471_14387(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1471_14389(EIF_REFERENCE);
static EIF_TYPED_VALUE F1471_14390_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1471_14390(EIF_REFERENCE);
...
void F1471_14384 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1470, Current, 0, 0, 20591);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1470, Current, 20591);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1471_14386 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1470, Current, 0, 1, 20592);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1470, Current, 20592);
	RTIV(Current, RTAL);
...
body:;
	...
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(10263, dtype))(Current, ui4_1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTDBGLE;
...
EIF_TYPED_VALUE F1471_14387 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1470, Current, 0, 0, 20593);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTAOMS(14386,1);
	RTDBGEAA(1470, Current, 20593);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,1);
	RTCOMS(tr2,14386,0,"W",1,87);
	ur1 = tr2;
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(8509, "string_width", tr1))(tr1, ur1x)).it_i4);
...
EIF_TYPED_VALUE F1471_14389 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1470, Current, 0, 0, 20594);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1470, Current, 20594);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
static EIF_TYPED_VALUE F1471_14390_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1470, Current, 0, 0, 20595);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1470, Current, 20595);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1471_14390 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9327, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1471_14390_body (Current)).it_r;
