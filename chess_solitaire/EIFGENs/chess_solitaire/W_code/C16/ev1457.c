...
extern void F1457_14109(EIF_REFERENCE);
static EIF_TYPED_VALUE F1457_14110_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1457_14110(EIF_REFERENCE);
extern void F1457_16503(EIF_REFERENCE, int);
...
void F1457_14109 (EIF_REFERENCE Current)
{
	GTCX
...
static EIF_TYPED_VALUE F1457_14110_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1456, Current, 0, 0, 20319);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1457_14110 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9327, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1457_14110_body (Current)).it_r;
...
void F1457_16503 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1456, Current, 0, 16502);
	RTSA(dtype);
	RTME(dtype, 0);
