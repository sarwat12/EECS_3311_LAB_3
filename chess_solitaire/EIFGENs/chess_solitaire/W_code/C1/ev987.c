...
extern void F987_25504(EIF_REFERENCE, int);
...
void F987_8970 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 986, Current, 0, 0, 15271);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(986, Current, 15271);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F987_25504 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 986, Current, 0, 25503);
	RTSA(dtype);
	RTME(dtype, 0);
