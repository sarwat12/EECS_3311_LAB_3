...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1621, Current, 0, 1, 17494);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1621, Current, 17494);
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1621, Current, 1, 1, 17495);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1621, Current, 17495);
	RTCC(arg1, 1621, l_feature_name, 1, RTWCT(4633, dtype, Dftype(Current)), 0x06);
	uarg1 = (EIF_BOOLEAN) RTS_OU (arg1);
	uarg = uarg1;
	if (uarg) {
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1621, Current, 0, 0, 17496);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1621, Current, 17496);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("valid_operands", EX_PRE);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1621, Current, 0, 1, 17497);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1621, Current, 17497);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1621, Current, 0, 1, 17498);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1621, Current, 17498);
	RTCC(arg1, 1621, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1621, Current, 0, 1, 17499);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1621, Current, 17499);
...
void F1622_6506 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1621, Current, 1, 0, 17500);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1621, Current, 17500);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 4635, 0x10000000, 0); /* last_result */
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1621, Current, 2, 1, 17501);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1621, Current, 17501);
	if (arg1) {
		{
...
#define arg10 arg10x.it_p
	...
	RTEAA(l_feature_name, 1621, Current, 0, 10, 17502);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1621, Current, 17502);
	RTIV(Current, RTAL);
