...
extern EIF_TYPED_VALUE F1536_15600(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1536_15601(EIF_REFERENCE);
extern void F1536_15602(EIF_REFERENCE);
extern void F1536_15603(EIF_REFERENCE);
extern void F1536_15604(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1536_15600 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1536_15601 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F1536_15601,21661,RTMS_EX_H("\012",1,10));
}

/* {KL_TEXT_INPUT_FILE}.read_line */
void F1536_15602 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1535, Current, 5, 0, 21661);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1535, Current, 21661);
	RTIV(Current, RTAL);
...
body:;
	...
	*(EIF_BOOLEAN *)(Current + RTWA(11417, dtype)) = (EIF_BOOLEAN) loc4;
	if (RTAL & CK_ENSURE) {
		RTHOOK(20);
...
void F1536_15603 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1535, Current, 0, 0, 21662);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1535, Current, 21662);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("is_open_read", EX_PRE);
...
void F1536_15604 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1535, Current, 0, 0, 21663);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1535, Current, 21663);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
