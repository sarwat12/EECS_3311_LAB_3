...
extern EIF_TYPED_VALUE F1545_15840(EIF_REFERENCE);
...
RTOID (F1545_15840)
EIF_TYPED_VALUE F1545_15840 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_CHARACTER_8)
	RTOTDB(EIF_CHARACTER_8, F1545_15840);
	dtype = Dtype(Current);
	...
	RTEAA(l_feature_name, 1544, Current, 0, 0, 21852);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
