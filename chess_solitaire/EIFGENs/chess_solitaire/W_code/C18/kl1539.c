...
extern void F1539_15611(EIF_REFERENCE);
extern void F1539_15612(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1539_15613(EIF_REFERENCE);
...
void F1539_15611 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1538, Current, 5, 0, 21670);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1538, Current, 21670);
	RTIV(Current, RTAL);
...
body:;
	...
	*(EIF_BOOLEAN *)(Current + RTWA(11417, dtype)) = (EIF_BOOLEAN) loc5;
	if (RTAL & CK_ENSURE) {
		RTHOOK(26);
...
void F1539_15612 (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1539_15613 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F1539_15613,21673,RTMS_EX_H("\015\012",2,3338));
}

void EIF_Minit1539 (void)
{
	GTCX
	RTOTS (15613,F1539_15613)
}
