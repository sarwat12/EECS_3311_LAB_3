...
extern EIF_TYPED_VALUE F1522_15307(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1522_15307 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1521, Current, 0, 0, 21427);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1521, Current, 21427);
	RTIV(Current, RTAL);
	RTHOOK(1);
