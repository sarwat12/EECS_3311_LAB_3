...
extern void F1532_15573(EIF_REFERENCE);
extern void F1532_15574(EIF_REFERENCE);
...
void F1532_15573 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1531, Current, 0, 0, 21638);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F1532_15574 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1531, Current, 0, 0, 21639);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
