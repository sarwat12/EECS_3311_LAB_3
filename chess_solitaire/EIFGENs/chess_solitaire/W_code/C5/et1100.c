...
extern void F1100_9461(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1100_9462(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1100_9463(EIF_REFERENCE);
...
/* {ETF_TUPLE_ARG}.make */
void F1100_9461 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1099, Current, 0, 1, 15716);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1099, Current, 15716);
	{
	...
	*(EIF_REFERENCE *)(Current + RTWA(7155, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 7177, 0xF800014E, 0); /* value */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
/* {ETF_TUPLE_ARG}.value */
EIF_TYPED_VALUE F1100_9462 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
/* {ETF_TUPLE_ARG}.out */
EIF_TYPED_VALUE F1100_9463 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1099, Current, 1, 0, 15718);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1099, Current, 15718);
	RTIV(Current, RTAL);
	RTHOOK(1);
